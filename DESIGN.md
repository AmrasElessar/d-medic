> **Design reference:** [linear](https://github.com/Khalidabdi1/design-ai/blob/main/design-md/linear/DESIGN.md) — used as inspiration for dmedic's visual direction.
> **Source:** Khalidabdi1/design-ai (MIT). Not a copy of linear's product — extracted design *language* notes for Claude to reference when generating UI.
